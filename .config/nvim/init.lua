...
-- Setting light and dark lumen themes
vim.g.lumen_light_colorscheme = "catppuccin-latte"
vim.g.lumen_dark_colorscheme = "catppuccin-mocha"
...
vim.keymap.set('n', '<leader>fw', telescope_live_grep_open_files, { desc = '[F]ind [W]ord in current buffer' })
